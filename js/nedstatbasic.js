...
function nedstatbasic(id,options)
{
	...
	var u="https://web.archive.org/web/20040626175012/http://m1.nedstatbasic.net/n?id="+id;
	var r;
	if (options&1)
		r=d.referrer;
	else
	...
	u+="&rn="+ Math.floor(Math.random()*2000000000);
...
playback timings (ms):
  ...
  esindex: 0.019
  cdx.remote: 32.292
  LoadShardBlock: 115.749 (3)
  PetaboxLoader3.datanode: 236.958 (4)
  load_resource: 268.001
  PetaboxLoader3.resolve: 112.506
*/